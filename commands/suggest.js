...
/*const {ChatInputCommandInteraction, ModalBuilder, TextInputStyle, ActionRowBuilder, ButtonStyle} = require('discord.js');
const GuildConfiguration = require ('../models/GuildConfiguration');
...
/*run: async({interaction,client,handler}) => {
    ...
    modualInteraction.editReply('Suggestion created!');
